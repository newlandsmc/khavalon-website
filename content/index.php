...
<html lang="en">
  <head>
    <title>Khavalon Minecraft Server | PVP | Hard Survival</title>
    ...
    <main>
      ...
      <div class="content" id="landing">
        ...
        <section class="center">
          ...
          <div>
            <h3>+ No Shortcuts</h3>
            <p>There is no tpa or homes on Khavalon. There's no sleep percentage either, so night could be a threat, especially with vanilla spawn rates - unlit corners are unforgiving. This is classic survival at its core.</p>
          </div>
        </section>
        <section class="center">
          <div>
